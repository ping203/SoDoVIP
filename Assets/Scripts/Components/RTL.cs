...
public class RTL
{
    ...
    public static int[][] selectEqua(int[][] trip, int[][] straight, int[] cardWin, bool isOther)
    {
        ...
        else if (lenStraight == 2)
        {
            ...
            {// 2s
                ...
                if (trip1 != -1 && trip2 == -1)
                {// trip 1 chua, trip 2 khong
                    if (trip[0].Length == 4)
                    {
                        if (checkExistCardInPhom(cardWin, case1[0]) == -1
                                && getNumCardwin(trip[0], cardWin) < 2)
                        {// khong
                            // phai
                            // cardwin
                ...
                if (trip1 == -1 && trip2 != -1)
                {// trip 2 chua, trip 1 khong
                    if (trip[1].Length == 4)
                    {
                        if (checkExistCardInPhom(cardWin, case2[0]) == -1 &&
                                getNumCardwin(trip[1], cardWin) < 2)
                        {// khong
                            // phai
                            // cardwin
                ...
                // chua card win
                // }
                if (trip1 != -1 && trip2 != -1 && str1 != -1 && str2 == -1)
                {// tri
            ...
            else if (case1[0] != -1 && case1[1] != -1 && case2[0] == -1 && case2[1] == -1)
            {// s1
                // trung
                // 2t,
                // s2
    ...
    public static int[][] getPhom3(int[] card, int[] cardWin)
    {
        ...
        if (lenStraight > lenTrip)
        {// phom sanh nhieu hon trips
        ...
        else if (lenStraight < lenTrip)
        {// phom trip nhieu hon sanh
    ...
    public static bool checkCardHit(int[] card, int[] cardWin, int c)
    {
        if (card != null && cardWin != null)
        {
            ...
            if (visPhom != -1)
            {
                ...
                if (isPhom(tempArr))
                {// pháº£i phá»?m sau khi Ä‘Ã¡nh ra lÃ¡
                    // bÃ i
    ...
    public static int[][] selectPhomStraight(int[][] straight, int[] trip, int[] cardWin)
    {
        ...
        if (case1[0] == -1 && case1[1] == -1)
        {// sanh va trip ko trung nhau
            result = straight;
        ...
        else if (case1[0] != -1 && case1[1] != -1)
        {
            if (trip.Length == 3)
            {
                ...
                else
                {
                    ...
                    if (strai1 != -1 && strai2 == -1)
                    {// sanh 1 co cardWin sanh
                        // 2 ko
                        if (card1 != -1)
                        {// card trung la card win
                            if (tempSt1 != null && tempSt2 != null)
                            {
                                result = setinfoArray(result, trip);
                                result = setinfoArray(result, tempSt1[0]);
    ...
    public static int[][] selectPhomTrip(int[][] trip, int[] straight, int[] cardWin)
    {
        ...
        if (haveCardWin == -1)
        {// khong ton tai cardWin trong phom sanh
            // case1 = checkDupStraightTrip(trip, straight[0]);
            if (dup[0] != -1 && dup[1] != -1)
            {// sanh nam giua trip
                if (trip1 == -1 && trip2 == -1)
                {// ko co trip nao chua card win
            ...
            {// trung trip 1 ko trung trip 2
                if (trip1 != -1)
                {// phom trip1 co chứa card wins
                    if (trip[0].Length == 3)
                    {
        ...
        {// ton tai card win trong phom sanh
            if (dup[0] == -1 && dup[1] == -1)
            {
                result = trip;
                result = setinfoArray(result, straight);
            ...
            {// 2 trip trung straight   
                if (trip1 == -1 && trip2 == -1)
                {// 2 trip ko chua cardwinp
                ...
                if (trip1 != -1 && trip2 == -1)
                {// trip 1 chua cardWin trip2 ko
                    if (card1 != 1)
                    {// la trung la la trong card win
                        if (lenTrip1 == 3 && lenTrip2 == 3)
                        {
            ...
            int cardCheck)
    {
        ...
        else if (checkTrip(src))
        {// phom trip
            if ((stPhom != -1 && checkCard != -1))
            {// phom Ä‘Ã£ Äƒn vÃ o 1 card
                // or
    ...
    {// mang cac so thu tu quan bai tu 0-51
        int[] turn = arr;
