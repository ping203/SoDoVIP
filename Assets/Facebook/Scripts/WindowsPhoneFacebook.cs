...
namespace Facebook {
    ...
    sealed class WindowsPhoneFacebook : AbstractFacebook, IFacebook {
        ...
        public override void AppEventsLogPurchase (float logPurchase,
            string currency = "USD",
            Dictionary<string, object> parameters = null) {
            Debug.LogError ("AppEventsLogPurchase not implemented on WP8");
        }
        public override void AppRequest (string message,
            string[] to = null,
            List<object> filters = null,
            string[] excludeIds = null,
            int? maxRecipients = null,
